...
public class GameManagerGame3 : MonoBehaviour
{
    ...
    void Start()
    {
		weapon=(GameObject)Instantiate(Resources.Load("redBird")) ;
        ...
        Camera.main.transform.positionTo
            ...
            setOnCompleteHandler((x) =>
				...
				if (health<=0)
					...
					Animator	animator2=GameObject.FindGameObjectWithTag("maya").GetComponent<Animator>();
    ...
    {
        CurrentGameState = GameState.BirdMovingToSlingshot;
		Animator	animator=GameObject.FindWithTag("ennemi").GetComponent<Animator>();
		...
		weapon.transform.positionTo
		(Vector2.Distance(weapon.transform.position / 10,
    ...
    {
		cameraFollow.BirdToFollow = weapon.transform;
